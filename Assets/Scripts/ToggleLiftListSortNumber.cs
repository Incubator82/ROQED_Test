...
public class ToggleLiftListSortNumber : MonoBehaviour
{
    ...
    public void SortText(bool orderBy)
    {
        ...
        BilletManager.BilletsLeftList = orderBy == true ? BilletManager.BilletsLeftList.OrderBy(_ => _.Number).ToList() :
                                                          BilletManager.BilletsLeftList.OrderByDescending(_ => _.Number).ToList();
